...
class AllVerifiedSellerScreen extends StatefulWidget {
  const AllVerifiedSellerScreen({Key? key}) : super(key: key);

  @override
  State<AllVerifiedSellerScreen> createState() => _AllVerifiedSellerScreenState();
}

class _AllVerifiedSellerScreenState extends State<AllVerifiedSellerScreen> {
