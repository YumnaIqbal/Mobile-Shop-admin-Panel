...
class AllBlockedRiderScreen extends StatefulWidget {
  const AllBlockedRiderScreen({Key? key}) : super(key: key);

  @override
  State<AllBlockedRiderScreen> createState() => _AllBlockedRiderScreenState();
}

class _AllBlockedRiderScreenState extends State<AllBlockedRiderScreen> {
  ...
  Widget build(BuildContext context) {
    Widget displayBlockedRiderDesign(){
      if(allRiders != null){
    ...
    return Scaffold(
      ...
      body: Center(
        child: Container(
          ...
          child: displayBlockedRiderDesign(),
        ),
      ),
    );
  }
